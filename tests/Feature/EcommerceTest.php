...
class EcommerceTest extends TestCase
{
    ...
    // Prueba 5: Usuario autenticado no es redirigido al login
    public function test_usuario_autenticado_no_es_redirigido_al_login(): void
    {
        $usuario = Usuario::factory()->create(['rol' => 'cliente']);

        // Un usuario autenticado que intenta ir al login debe ser redirigido al dashboard
